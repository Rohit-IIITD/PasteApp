  ...
  return (
    <div>
      ...
      <div className="mt-2.5 border-2 border-gray-300 w-[1000px] mx-auto rounded-md p-4">
        <h1 className="font-bold text-left text-4xl  border-b-2 border-gray-300 pb-2 pl-4">All Pastes</h1>
        <div className="flex flex-col gap-4 mt-4 w-[1000px] mx-auto rounded-md p-2 ">
          {filteredData.length > 0 &&
            filteredData.map((paste) => {
              return (
                <div className="border-2 border-gray-300 w-[950px] h-[110px]" key={paste?._id}>
                  <div className="text-2xl font-bold text-left p-3">{paste.title}</div>
                  ...
                  <div className="flex flex-row place-content-end gap-x-4 w-[950px] -mt-8 pr-4">
                    ...
                    <button className="border-2 border-gray-300 rounded-md p-1.5">
                      <a href={`/pastes/${paste?._id}`}><i class="fa-solid fa-eye"></i></a>
                    </button>
                    <button className="hover:cursor-pointer border-2 border-gray-300 rounded-md p-1.5" onClick={() => handleDelete(paste?.id)}>
                      <i class="fa-solid fa-trash"></i>
                    </button>
                    <button className="hover:cursor-pointer border-2 border-gray-300 rounded-md p-1.5"
                      onClick={() => {
                    ...
                    <button className="border-2 border-gray-300 rounded-md p-1.5"><i class="fa-solid fa-share-nodes"></i></button>
                  </div>
